...
import com.sheep.cg.PropertyNamer;
import com.sheep.protocol.constant.Constant;
import com.sheep.protocol.constant.magic.Symbol;
import com.sheep.utils.ClassUtils;
...
public abstract class AbstractEntityManagerAdapter implements EntityManager {
    ...
    private List<Field> extractFields(Class<?> clazz) {
        Method[] orderedMethods = ClassUtils.getOrderedMethod(clazz.getMethods());
        List<java.lang.reflect.Field> fieldList = ClassUtils.extractFields(clazz);
        java.lang.reflect.Field[] fields = ClassUtils.getOrderedFields(fieldList);
        ...
        for (Method method : orderedMethods) {
            ...
            String propertyName = StringUtils.setFirstByteLowerCase(PropertyNamer.methodToProperty(method.getName()));
    ...
    public void initTable() {
        ...
        if (clazz.isAnnotationPresent(Table.class)) {
            ...
            this.tableName = StringUtils.setFirstByteLowerCase(clazz.getSimpleName());
        }
        ...
        if (split.table_bucket_count() > 1) {
            ...
            Object configBucketCount = ConfigUtils.getValue(bucketCountConfigKey);
